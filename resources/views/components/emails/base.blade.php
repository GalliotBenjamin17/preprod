...
<div role="article" aria-roledescription="email" aria-label="@isset($title) {{ $title }} @endisset" lang="en">
                                ...
                                <tr>
                                    <td class="dark-bg-gray-1000 dark-text-gray-100" style="border-radius: 4px; background-color: #fff; padding: 40px; text-align: left; font-size: 16px; color: #46586B">
                                        <a href="{{ route('login') }}" style="text-decoration: none">
                                            <img src="{{ asset($logo) }}" width="130" alt="{{ $name }}" style="border: 0; max-width: 100%; vertical-align: middle; line-height: 100%">
                                        </a>
