...
class FullyFinancedNotification extends Notification implements ShouldQueue
{
    ...
    public function toMail($notifiable): MailMessage
    {
        ...
        return (new MailMessage)
            ->subject($tenant->name.' - Financement du projet atteint')
            ->from($this->getSenderAddress($tenant), $this->getSenderName($tenant))
            ->view('emails.notifications.projects.fully-financed', [
                'tenant' => $tenant,
